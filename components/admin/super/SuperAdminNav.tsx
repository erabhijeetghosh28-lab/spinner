...
export default function SuperAdminNav() {
  ...
  const navLinks = [
    { href: '/admin/super/dashboard', label: 'Dashboard', icon: '📊' },
    { href: '/admin/super/analytics', label: 'Analytics', icon: '📈' },
    { href: '/admin/super/campaigns', label: 'Campaigns', icon: '📢' },
    { href: '/admin/super/vouchers', label: 'Vouchers', icon: '🎟️' },
    { href: '/admin/super/whatsapp', label: 'WhatsApp', icon: '💬' },
    { href: '/admin/super/security', label: 'Security', icon: '🔒' },
    { href: '/admin/super/audit-logs', label: 'Audit Logs', icon: '📋' },
  ];
    ...
    <div className="bg-slate-900 border-b border-slate-800">
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          {/* Logo and Title */}
          <Link href="/admin/super/dashboard" className="flex items-center space-x-4 hover:opacity-80 transition-opacity">
            <div className="w-12 h-12 bg-amber-500 rounded-xl flex items-center justify-center text-slate-900 text-2xl font-black">
              👑
            </div>
            <div>
              <h1 className="text-2xl font-bold text-amber-500">Super Admin</h1>
