...
const NeonWheel: React.FC<NeonWheelProps> = ({ prizes, controls, segmentAngle, config }) => {
    ...
    return (
        ...
        >
            ...
            <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full border-4 border-black z-10 flex items-center justify-center shadow-2xl"
                style={{
            ...
            >
                <span className="text-white font-black text-xs">WIN</span>
            </div>
        </motion.div>
    );
};
