                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {plans.map((plan, i) => {
                                ...
                                features.push(`Campaign Duration: ${plan.campaignDurationDays} Days`);
                                
                                // Determine if featured (from isMostPopular flag)
            ...
            <section id="contact" className="py-24 bg-white overflow-hidden relative">
                ...
                <div className="max-w-7xl mx-auto px-6 relative">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                            Have questions or need a custom solution? Our team is here to help you scale your digital marketing.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 hover:border-green-500/30 transition-all duration-300 group">
                            ...
                            <h4 className="font-bold text-xl mb-4 text-slate-900">WhatsApp Support</h4>
                            <div className="space-y-3">
                                <a href="https://wa.me/918076074179" target="_blank" rel="noopener noreferrer" className="block text-slate-600 hover:text-green-600 font-medium transition-colors">+91 80760 74179</a>
                                <a href="https://wa.me/918638310045" target="_blank" rel="noopener noreferrer" className="block text-slate-600 hover:text-green-600 font-medium transition-colors">+91 86383 10045</a>
                            </div>
                        </div>
                        ...
                        <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 hover:border-cyan-500/30 transition-all duration-300 group">
                            ...
                            <h4 className="font-bold text-xl mb-4 text-slate-900">Email Us</h4>
                            <a href="mailto:raju@clickgenieinfo.com" className="text-slate-600 hover:text-cyan-600 font-medium transition-colors">raju@clickgenieinfo.com</a>
                        </div>
                        ...
                        <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 hover:border-indigo-500/30 transition-all duration-300 group">
                            ...
                            <h4 className="font-bold text-xl mb-4 text-slate-900">Our Website</h4>
                            <a href="https://www.clickgenieinfo.com/" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-indigo-600 font-medium transition-colors">www.clickgenieinfo.com</a>
                        </div>
                        ...
                        <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 hover:border-amber-500/30 transition-all duration-300 group">
                            ...
                            <h4 className="font-bold text-xl mb-4 text-slate-900">GSTN Registration</h4>
                            <div className="bg-white px-4 py-2 rounded-xl border border-amber-200 inline-block font-mono text-amber-700 font-bold">
                                07AAVFC2134L1Z5
                            </div>
                        </div>
                    </div>
